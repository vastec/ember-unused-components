...
module.exports = {
  ...
  getConfig(commandOptions) {
    ...
    let appPath =
      commandOptions.path +
      (_isAddon(commandOptions) ? constants.APP_PATH_FOR_ADDONS : constants.APP_PATH);
    ...
    this.config.addonsPath = commandOptions.path + constants.NODE_MODULE_PATH;
    this.config.addonsComponentSuffix = constants.DEFAULT_ADDONS_COMPONENTS_DIR_NAME;
