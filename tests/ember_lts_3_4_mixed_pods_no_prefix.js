...
test('3.4 LTS POD no prefix - get config', t => {
  let expectedConfig = {
    appPath: '/test-apps/ember_lts_3_4_pod_no_prefix/app/',
    ignore: ['app/templates/freestyle.hbs'],
    usePods: true,
    useModuleUnification: false,
    includeAddons: false,
    whitelist: ['z-button'],
    componentsPath: '/test-apps/ember_lts_3_4_mixed_pod_no_prefix/app/components',
    failOnUnused: false,
  };
  let commandOptions = { path: '/test-apps/ember_lts_3_4_mixed_pod_no_prefix/' };
...
test('3.4 LTS POD no prefix - map components', t => {
  let config = {
    appPath: '/test-apps/ember_lts_3_4_mixed_pod_no_prefix/app/',
    ignore: ['app/templates/freestyle.hbs'],
    usePods: true,
    useModuleUnification: false,
    whitelist: ['z-button'],
